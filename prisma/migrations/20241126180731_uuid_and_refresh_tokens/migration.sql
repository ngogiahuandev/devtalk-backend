/*
  ...
  - The primary key for the `ReadHistory` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- DropForeignKey
ALTER TABLE "ReadHistory" DROP CONSTRAINT "ReadHistory_postId_fkey";

-- DropForeignKey
ALTER TABLE "ReadHistory" DROP CONSTRAINT "ReadHistory_userId_fkey";
...
-- AlterTable
ALTER TABLE "ReadHistory" DROP CONSTRAINT "ReadHistory_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ALTER COLUMN "userId" SET DATA TYPE TEXT,
ALTER COLUMN "postId" SET DATA TYPE TEXT,
ADD CONSTRAINT "ReadHistory_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "ReadHistory_id_seq";
...
-- AddForeignKey
ALTER TABLE "ReadHistory" ADD CONSTRAINT "ReadHistory_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
